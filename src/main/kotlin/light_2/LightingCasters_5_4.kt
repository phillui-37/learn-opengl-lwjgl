...
object LightingCasters_5_4 : ILesson {
    ...
    override fun init() {
        ...
        shaders.add(Shader("light_2/light_caster", "light_2/light_caster_4"))
    ...
    override fun loop() {
        ...
        while (!GLFW.glfwWindowShouldClose(window)) {
            ...
            with(lightingShader) {
                ...
                setFloat("light.cutOff", Math.cos(Math.toRadians(12.5f)))
                setFloat("light.outerCutOff", Math.cos(Math.toRadians(17.5f)))
                ...
                setVec3("light.direction", camera.front)
